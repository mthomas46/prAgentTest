...
function createCodeSizeChart(metrics) {
...
function createFileTypeChart(metrics) {
...
function createHistoricalTrendsChart(metrics) {
...
async function initStatistics() {
    ...
    try {
        ...
        containers.forEach(container => {
            container.innerHTML = '<div class="error">Failed to load statistics. Please try again later.</div>';
        });
    }
}
