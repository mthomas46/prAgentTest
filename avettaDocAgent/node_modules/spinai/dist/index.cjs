...
async function runTaskLoop(taskLoopParams) {
  ...
  try {
    ...
    while (stepCount < maxSteps) {
        ...
        nextActions = [
          {
            ...
            toolCallId: `call_${Date.now()}_${uuid.v4().substring(0, 8)}`
          }
        ];
      ...
      nextActions.forEach((action) => {
        action.toolCallId = `call_${Date.now()}_${uuid.v4().substring(0, 8)}`;
      });
...
async function createActionsFromMcpConfig({
  ...
  var _a16, _b;
  const actions = [];
  const npmPrefix = child_process.execSync("npm prefix -g").toString().trim();
  const npxPath = path__namespace.join(npmPrefix, "bin", "npx");
...
exports.MODEL_COSTS = MODEL_COSTS;
...
exports.createActionsFromMcpConfig = createActionsFromMcpConfig;
exports.createAgent = createAgent;
exports.createAssistantMessage = createAssistantMessage;
exports.createAssistantTextMessage = createAssistantTextMessage;
exports.createAssistantToolCallsMessage = createAssistantToolCallsMessage;
exports.createSystemMessage = createSystemMessage;
exports.createUserMessage = createUserMessage;
exports.formatActionForPrompt = formatActionForPrompt;
exports.formatActionsForPrompt = formatActionsForPrompt;
exports.getPackageVersion = getPackageVersion;
exports.log = log;
exports.planningSchema = planningSchema;
exports.runTaskLoop = runTaskLoop;
exports.setDebugEnabled = setDebugEnabled;
exports.startCliChat = startCliChat;
